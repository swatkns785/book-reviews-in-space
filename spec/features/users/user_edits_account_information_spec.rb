...
Acceptance Criteria
[ ] User sees name fields, email field and role.
[ ] User changes password and is able to log in with new password, sees confirmation messages.
[ ] User logs in with new password and it is successful.
[ ] User tries to log in with old password and sees invalid password message.

) do

  context "successful attempt at changing password"

    scenario "user succesfully changes password" do
